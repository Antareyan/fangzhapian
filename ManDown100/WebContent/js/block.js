...
NormalBlock.prototype.initSprite = function(){//初始化普通障碍物
	...
	sprite.add("normal",new WF.sprite.Animation({sw:200,sh:32,width:180,height:30,dir:"down"}));
...
MissBlock.prototype.initSprite = function(){//初始化 消失障碍物
	...
	sprite.add("normal",new WF.sprite.Animation({startY:32,sw:200,sh:32,width:180,height:30,dir:"down"}));
...
LeftBlock.prototype.initSprite = function(){//初始化左滑障碍物
	...
	sprite.add("normal",new WF.sprite.Animation({sw:200,sh:32,width:180,height:30,dir:"down",fs:2,loop:true}));
...
RightBlock.prototype.initSprite = function(){//初始化 右滑障碍物
	...
	sprite.add("normal",new WF.sprite.Animation({startY:64,sw:200,sh:32,width:180,height:30,dir:"down",fs:2,loop:true}));
...
FlipBlock.prototype.initSprite = function(){//初始化弹跳障碍物
	...
	sprite.add("normal",new WF.sprite.Animation({sw:200,sh:32,width:180,height:30,dir:"down"}));
	sprite.add("down",new WF.sprite.Animation({startY:32,sw:200,sh:90,width:180,height:30,dir:"down"}));
	sprite.add("up",new WF.sprite.Animation({startY:56,sw:200,sh:43,width:180,height:50,dir:"down"}));
...
var BlockFactory = {//障碍物制造工厂
	...
	create : function(){//创建
		...
		var rnd_x = Math.floor(Math.random()*630);
