...
var Main = {
	...
	initData : function(){//初始化数据
		...
		WF.file.imgs(["img/man.png","img/block.png","img/move.png","img/thorn.png","img/flip.png","img/thorn_bg.png","img/fzdh.png","img/kj1.png","img/kj2.png","img/kj3.png","img/kj4.png","img/kj5.png","img/kj6.png"],function(imgs){
	...
	initBlock : function(imgs){//初始化障碍物
		...
		var block = new NormalBlock(1200,460,imgs[1],Main.cxt,Main.gameInfo);
	...
	over : function(){
		...
		if(this.level >= 3){
			...
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "好厉害,你下了<label>"+this.level+"</label>层";
			...
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "不会吧,你才下了<label>"+this.level+"</label>层";
			WF.getId("js_end_flush").getElementsByTagName("a")[0].innerHTML = "再来一次";
